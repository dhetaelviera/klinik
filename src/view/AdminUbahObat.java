 ...
 */
public class AdminUbahObat extends javax.swing.JFrame {

    /**
     * Creates new form AdminUbahObat
     */
    public AdminUbahObat() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        namaObat.setFont(new java.awt.Font("Myanmar Text", 0, 14)); // NOI18N
        getContentPane().add(namaObat, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 190, 180, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminUbahObat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminUbahObat().setVisible(true);
            }
        });
    }
