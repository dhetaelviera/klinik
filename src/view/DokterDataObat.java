 ...
 */
public class DokterDataObat extends javax.swing.JFrame {

    /**
     * Creates new form AdminDataObat
     */
    public DokterDataObat() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(username, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 40, 180, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DokterDataObat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DokterDataObat().setVisible(true);
            }
        });
    }
