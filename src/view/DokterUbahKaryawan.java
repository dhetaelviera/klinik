 ...
 */
public class DokterUbahKaryawan extends javax.swing.JFrame {

    /**
     * Creates new form AdminUbahObat
     */

    public DokterUbahKaryawan() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DokterUbahKaryawan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DokterUbahKaryawan().setVisible(true);
            }
        });
    }
