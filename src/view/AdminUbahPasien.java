 ...
 */
public class AdminUbahPasien extends javax.swing.JFrame {
    ...
    public void periksaListener (ActionListener a){
        periksa.addActionListener(a);
    }
    
    public void keuanganListener (ActionListener a){
        keuangan.addActionListener(a);
    }
    ...
    public JButton keuanganB(){
        return keuangan;
    }
    public JButton periksaB(){
        return periksa;
    }
    ...
    private void initComponents() {
        ...
        keuangan = new javax.swing.JButton();
        ...
        keterangan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "nggapleki", "agak nggapleki","aman"}));
        ...
        getContentPane().add(tambah, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 470, -1, 40));
        ...
        periksa.setBackground(new java.awt.Color(89, 133, 39));
        periksa.setFont(new java.awt.Font("Geometr415 Blk BT", 0, 14)); // NOI18N
        periksa.setForeground(new java.awt.Color(255, 255, 204));
        periksa.setText("Data Periksa");
        getContentPane().add(periksa, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 100, 150, 40));

        keuangan.setBackground(new java.awt.Color(89, 133, 39));
        keuangan.setFont(new java.awt.Font("Geometr415 Blk BT", 0, 14)); // NOI18N
        keuangan.setForeground(new java.awt.Color(255, 255, 204));
        keuangan.setText("Keuangan");
        getContentPane().add(keuangan, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 100, 140, 40));
        ...
        getContentPane().add(warna, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 420, 50, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminUbahPasien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminUbahPasien().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton keuangan;
